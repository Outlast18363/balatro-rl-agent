...
def build_observation_space() -> spaces.Dict:
    ...
    return spaces.Dict({
        ...
        'deck_card_ids':          spaces.Box(-1, 51, (MAX_DECK_SIZE,), np.int16),
        ...
        'target_score':           spaces.Box(0, np.iinfo(np.int64).max, (), np.int64),
        'blind_reward':           spaces.Box(0, 1_000_000, (), np.int32),

        # ── Combat (PLAY) fields ──────────────────────────────
        'hand_card_ids':          spaces.Box(-1, 51, (MAX_HAND_SIZE,), np.int16),
        ...
        'current_score':          spaces.Box(0, np.iinfo(np.int64).max, (), np.int64),
        'hand_size':              spaces.Box(0, 12, (), np.int16),
        'hands_remaining':        spaces.Box(0, 12, (), np.int16),
        'discards_remaining':     spaces.Box(0, 12, (), np.int16),
